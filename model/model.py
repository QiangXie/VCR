...
class LSTMOCR(object):
    ...
    def build_graph(self, train_num_batches_per_epoch):
        self._build_model()
        self._build_train_op(train_num_batches_per_epoch)

        self.merged_summay = tf.summary.merge_all()

    def _build_model(self):
        filters = [[FLAGS.image_channel, 64], 
                [64, 128], 
                [128, 128],
                [128, 128, FLAGS.out_channels]]
        strides = [1, 2]
    ...
    def _build_train_op(self, train_num_batches_per_epoch):
        ...
        self.lrn_rate = tf.train.exponential_decay(FLAGS.initial_learning_rate,
                                                   self.global_step,
                                                   FLAGS.decay_epoch*train_num_batches_per_epoch,
                                                   FLAGS.decay_rate,
                                                   staircase=True)
